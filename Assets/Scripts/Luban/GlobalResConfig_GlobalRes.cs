...
namespace cfg
{
public sealed partial class GlobalResConfig_GlobalRes : Luban.BeanBase
{
    public GlobalResConfig_GlobalRes(JSONNode _buf) 
    {
    ...
    public static GlobalResConfig_GlobalRes DeserializeGlobalResConfig_GlobalRes(JSONNode _buf)
    {
        return new GlobalResConfig_GlobalRes(_buf);
    }
    ...
    public const int __ID__ = 670099741;
