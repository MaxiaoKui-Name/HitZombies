...
namespace cfg
{
public sealed partial class heroConfig_HeroRes : Luban.BeanBase
{
    public heroConfig_HeroRes(JSONNode _buf) 
    {
    ...
    public static heroConfig_HeroRes DeserializeheroConfig_HeroRes(JSONNode _buf)
    {
        return new heroConfig_HeroRes(_buf);
    }
    ...
    public const int __ID__ = 981218499;
