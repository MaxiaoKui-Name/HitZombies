...
namespace cfg
{
public sealed partial class monsterConfignew_monsterConfig : Luban.BeanBase
{
    public monsterConfignew_monsterConfig(JSONNode _buf) 
    {
    ...
    public static monsterConfignew_monsterConfig DeserializemonsterConfignew_monsterConfig(JSONNode _buf)
    {
        return new monsterConfignew_monsterConfig(_buf);
    }
    ...
    public const int __ID__ = -1840540895;
