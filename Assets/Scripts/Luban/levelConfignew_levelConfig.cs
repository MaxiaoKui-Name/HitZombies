...
namespace cfg
{
public sealed partial class levelConfignew_levelConfig : Luban.BeanBase
{
    public levelConfignew_levelConfig(JSONNode _buf) 
    {
        ...
        { if(!_buf["note6"].IsNumber) { throw new SerializationException(); }  Note6 = _buf["note6"]; }
        ...
        { if(!_buf["note7"].IsNumber) { throw new SerializationException(); }  Note7 = _buf["note7"]; }
        { if(!_buf["quantity_max4"].IsNumber) { throw new SerializationException(); }  QuantityMax4 = _buf["quantity_max4"]; }
        { if(!_buf["note8"].IsNumber) { throw new SerializationException(); }  Note8 = _buf["note8"]; }
    ...
    {
        return new levelConfignew_levelConfig(_buf);
    }
