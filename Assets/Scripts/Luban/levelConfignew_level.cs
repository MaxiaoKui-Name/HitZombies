...
namespace cfg
{
public sealed partial class levelConfignew_level : Luban.BeanBase
{
    public levelConfignew_level(JSONNode _buf) 
    {
    ...
    public static levelConfignew_level DeserializelevelConfignew_level(JSONNode _buf)
    {
        return new levelConfignew_level(_buf);
    }
    ...
    public const int __ID__ = -1059906817;
