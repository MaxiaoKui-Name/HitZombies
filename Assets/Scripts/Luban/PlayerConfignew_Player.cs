...
namespace cfg
{
public sealed partial class PlayerConfignew_Player : Luban.BeanBase
{
    public PlayerConfignew_Player(JSONNode _buf) 
    {
    ...
    public static PlayerConfignew_Player DeserializePlayerConfignew_Player(JSONNode _buf)
    {
        return new PlayerConfignew_Player(_buf);
    }
    ...
    public const int __ID__ = -497072029;
