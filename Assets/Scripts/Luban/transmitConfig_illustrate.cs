...
namespace cfg
{
public sealed partial class transmitConfig_illustrate : Luban.BeanBase
{
    public transmitConfig_illustrate(JSONNode _buf) 
    {
    ...
    public static transmitConfig_illustrate DeserializetransmitConfig_illustrate(JSONNode _buf)
    {
        return new transmitConfig_illustrate(_buf);
    }
    ...
    public const int __ID__ = -85182470;
